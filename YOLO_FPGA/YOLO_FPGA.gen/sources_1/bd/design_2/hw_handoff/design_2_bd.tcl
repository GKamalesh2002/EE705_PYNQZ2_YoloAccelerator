...
proc create_root_design { parentCell } {
  ...
  set block_name YOLO2_FPGA
  set block_cell_name YOLO2_FPGA_0
  if { [catch {set YOLO2_FPGA_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $YOLO2_FPGA_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net YOLO2_FPGA_0_m_axi_DATA_BUS [get_bd_intf_pins YOLO2_FPGA_0/m_axi_DATA_BUS] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net YOLO2_FPGA_0_m_axi_DATA_BUS2 [get_bd_intf_pins YOLO2_FPGA_0/m_axi_DATA_BUS2] [get_bd_intf_pins smartconnect_1/S00_AXI]
  ...
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins YOLO2_FPGA_0/ap_rst_n] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net YOLO2_FPGA_0_interrupt [get_bd_pins YOLO2_FPGA_0/interrupt]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins YOLO2_FPGA_0/ap_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk]
